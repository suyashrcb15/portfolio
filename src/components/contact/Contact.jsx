...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_2uzx2qk', 'template_rxasmm3', formRef.current, {
            publicKey: 'b79aUezw9X_Cti4ZX',
          })
          .then(
            (result) => {
              setSuccess(true);
  ...
  return (
    <motion.div 
    ref = {ref} className="contact" variants={variants} intial="initial" whileInView="animate"> 
      <motion.div className="textContainer" variants={variants}>
        <motion.h1 variants={variants}>Let's work together</motion.h1>
        <motion.div className="item" variants={variants}>
            <h2>Mail</h2>
            <span>2k22.cse2213545@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
            <h2>City</h2>
            <span>Kanpur</span>
